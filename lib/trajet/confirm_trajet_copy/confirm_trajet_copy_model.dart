...
import 'confirm_trajet_copy_widget.dart' show ConfirmTrajetCopyWidget;
import 'package:flutter/material.dart';
import 'package:flutter/scheduler.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:provider/provider.dart';

class ConfirmTrajetCopyModel extends FlutterFlowModel<ConfirmTrajetCopyWidget> {
  ...
  // Stores action output result for [Custom Action - sendGetRequestWithParams] action in confirmTrajetCopy widget.
  List<dynamic>? resCalT;
  // Stores action output result for [Backend Call - API (Estimate price with distance)] action in confirmTrajetCopy widget.
