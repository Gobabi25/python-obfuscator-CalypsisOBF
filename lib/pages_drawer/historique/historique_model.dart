...
class HistoriqueModel extends FlutterFlowModel<HistoriqueWidget> {
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController1(
    ...
    return controller..addPageRequestListener(listViewGetRiderRequestListPage1);
  }

  void listViewGetRiderRequestListPage1(ApiPagingParams nextPageMarker) =>
      listViewApiCall1!(nextPageMarker)
          .then((listViewGetRiderRequestListResponse) {
        final pageItems = (ApisGoBabiGroup.getRiderRequestListCall.laListe(
                  listViewGetRiderRequestListResponse.jsonBody,
                )! ??
                [])
            .toList() as List;
        ...
        listViewPagingController1?.appendPage(
          ...
          (pageItems.length > 0)
              ? ApiPagingParams(
                  ...
                  lastResponse: listViewGetRiderRequestListResponse,
                )
              : null,
        );
      });
  ...
  PagingController<ApiPagingParams, dynamic> _createListViewController2(
    ...
    return controller..addPageRequestListener(listViewGetRiderRequestListPage2);
  }

  void listViewGetRiderRequestListPage2(ApiPagingParams nextPageMarker) =>
