                ...
                children: [
                  ...
                  Align(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.apiResulti9v =
                            await ApisGoBabiGroup.updateUserDetailCall.call(
                          id: getJsonField(
                            FFAppState().userInfo,
                            r'''$.id''',
                          ).toString(),
                          ...
                          idCode: _model.textController5.text,
                          profileImage: _model.uploadedLocalFile,
                        );

                        if ((_model.apiResulti9v?.succeeded ?? true)) {
                          ...
                          FFAppState().userInfo = getJsonField(
                            (_model.apiResulti9v?.jsonBody ?? ''),
                            r'''$.data''',
                          );
                          setState(() {});
                        } else {
                          print("erreurs ${_model.apiResulti9v?.bodyText}");
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Erreur lors de la modification du profil , veuillez recommencer ${_model.apiResulti9v?.statusCode}',
                                style: TextStyle(
                                  color: Colors.white,
                                  fontWeight: FontWeight.w600,
                                ),
