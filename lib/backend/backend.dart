...
import 'schema/img_car_record.dart';
...
export 'schema/img_car_record.dart';
...
/// Functions to query ImgCarRecords (as a Stream and as a Future).
Future<int> queryImgCarRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ImgCarRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ImgCarRecord>> queryImgCarRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ImgCarRecord.collection,
      ImgCarRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ImgCarRecord>> queryImgCarRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
